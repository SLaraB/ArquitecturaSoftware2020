...
channel.queue_bind(exchange='bot_lara', queue=queue_name, routing_key="wikipedia")
...
def callback(ch, method, properties, body):
    ...
    if str(body).startswith("b'[wikipedia]"):
        ...
        channel.basic_publish(exchange='bot_lara', routing_key="publicar_slack", body=query+":"+result)
