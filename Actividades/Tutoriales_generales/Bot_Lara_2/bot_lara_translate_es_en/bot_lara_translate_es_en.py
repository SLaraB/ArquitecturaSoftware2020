...
#El consumidor utiliza el exchange 'bot_lara'
...
channel.queue_bind(exchange='bot_lara', queue=queue_name, routing_key="traducir")
...
print(' bot_lara_Translate_Es_En Waiting for messages...')
...
def callback(ch, method, properties, body):
    ...
    if query.startswith("[traducir]") and len(str(body))<300:
        ...
        channel.basic_publish(exchange='bot_lara', routing_key="publicar_slack", body="traducción es->en:"+str(result[0]))
